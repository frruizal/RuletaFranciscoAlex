...
public class Concurso {
	...
	private Socket s2;
	private Socket s3;
	public Concurso(Socket s1,Socket s2,Socket s3) {
		this.s1=s1;
		this.s2=s2;
		this.s3=s3;
	}
	public void jugarPanel(Socket cliente1,Socket cliente2,Socket cliente3) {
		...
		try {
			...
			paneles[5]="yo soy el atender peticiones";
			paneles[6]="suerte a todos en el examen";
			paneles[7]="somos alumnos de la universidad";
			paneles[8]="el objetivo es aprender";
			paneles[9]="esta frase es la ultima que voy a poner";
			int aleatorio=randon.nextInt(10);
